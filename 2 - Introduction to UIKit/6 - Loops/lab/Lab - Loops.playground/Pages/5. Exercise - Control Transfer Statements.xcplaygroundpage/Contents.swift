...
//STILL NEED TO ADD SOME SORT OF OPERATOR TO ONLY PRINT EVEN INDEXED CHARACTERS
 ...
 */
var capitalsAndStates = ["Salt Lake City": "Utah", "Denver": "Colorado", "Sacramento": "California"]

for (capitals, states) in capitalsAndStates {
