...
//        Kind of like an if statement. if you get a value for this perameter, do this
        didSet {
...
var myHeight = Height(heightInInches: 2)
print(myHeight.heightInCentimeters)



print(myHeight.heightInCentimeters)
var dougsHeight = Height(heightInCentimeters: 20)
