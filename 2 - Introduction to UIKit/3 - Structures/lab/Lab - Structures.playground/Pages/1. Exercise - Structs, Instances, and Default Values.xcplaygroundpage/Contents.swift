...
favoriteBook.price = 5.64

print(favoriteBook)

print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages in total. And you can purchase this book for $\(favoriteBook.price) on Amazon.com")
