 ...
 */
var nameCollection = ["Grace", "Lucy", "Alex", "Jordan", "Talmage", "Josh", "Scott", "Doug"]
let sortedCollection1 = { nameCollection.sorted(by: forwards)
 ...
 */
let sortedCollection2 = nameCollection.sorted { (name1, name2) -> Bool in
        return name1 < name2
}
 ...
 */
let sortedCollection3 = nameCollection.sorted {$0 < $1}
