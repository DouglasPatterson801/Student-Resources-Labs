...
func mealInfo(meal: String) -> Meal? {
    return meals[meal]
}

print(mealInfo(meal: "Breakfast"))
/*:
 ...
 */
func dictionaryRetreaval() -> [String: Any] {
    if let unwrappedLog = UserDefaults.standard.dictionary(forKey: "mealLog") {
        return unwrappedLog
    } else {
        return [:]
    }
