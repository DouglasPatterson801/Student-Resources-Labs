...
*/
func calculateArea(xParameter: Double, yParameter: Double) -> Double? {
    guard xParameter > 0 && yParameter > 0 else {
        return nil
    }
    return Double(xParameter * yParameter)

}

calculateArea(xParameter: 4, yParameter: 4)

calculateArea(xParameter: -5, yParameter: 4)

calculateArea(xParameter: 10, yParameter: 20)
